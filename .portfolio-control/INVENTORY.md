...
- **Status:** release candidate; local Docker and reuse gates passed, exact-head CI pending
...
| Docker and CI | `Dockerfile`, `.github/workflows/ci.yml` | local Docker passed; remote CI pending |
